...
export default function AdminLandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f0b0c]">
      {/* Navigation */}
      <nav className="border-b border-[#0ea5e9]/20 bg-white/90 dark:bg-[#101c28]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#0ea5e9] rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">M</span>
            </div>
            <h1 className="text-xl font-bold text-[#0ea5e9] dark:text-white">MARSHALL ETHEL</h1>
          </div>
          <div className="flex items-center gap-4">
            <a href="#features" className="text-[#0ea5e9]/70 hover:text-[#0ea5e9] dark:text-white/80 dark:hover:text-white transition">
              Features
            </a>
            <a href="#overview" className="text-[#0ea5e9]/70 hover:text-[#0ea5e9] dark:text-white/80 dark:hover:text-white transition">
              Overview
            </a>
            <Link href="/auth/login">
              <Button className="bg-[#0ea5e9] hover:bg-[#0284c7] text-white">Login</Button>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        <div className="mb-8">
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-[#0ea5e9] dark:text-white mb-4">Marshall-ethel</h2>
          ...
          <Link href="/auth/login">
            <Button size="lg" className="bg-[#0ea5e9] hover:bg-[#0284c7] text-white">
              Admin Access
            </Button>
          </Link>
        </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 py-20">
        <h3 className="text-3xl md:text-4xl font-bold text-[#0ea5e9] dark:text-white mb-12 text-center">Powerful Features</h3>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              return (
              <Card key={idx} className="border-[#0ea5e9]/30 hover:shadow-lg transition">
      ...
      <section id="overview" className="max-w-7xl mx-auto px-4 py-20">
        <h3 className="text-3xl md:text-4xl font-bold text-[#0ea5e9] dark:text-white mb-12 text-center">System Overview</h3>
        <div className=" border border-[#0ea5e9]/30 rounded-xl p-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="rounded-lg p-4 border border-[#0ea5e9]/30 bg-white dark:bg-[#0a1620] hover:border-[#0ea5e9]/50 transition"
                  >
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 border-t border-[#0ea5e9]/20 pt-12">
            {[
              {
                icon: Lock,
                title: "Secure Access",
              ...
              return (
                <div key={idx} className="text-center">
                  <Icon className="w-12 h-12 text-[#0ea5e9] mb-4 mx-auto" />
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <div className="border border-[#0ea5e9]/30 rounded-xl p-12 text-center bg-white dark:bg-[#0a1620]">
          <h3 className="text-3xl font-bold text-[#0ea5e9] dark:text-white mb-4">Ready to Get Started?</h3>
      ...
      {/* Footer */}
      <footer className="border-t border-[#0ea5e9]/20 bg-white dark:bg-[#101c28] mt-20">
